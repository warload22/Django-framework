    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(default='icons/Gromp.png', upload_to='', verbose_name='icon')),
                ('age', models.PositiveSmallIntegerField(default=18, verbose_name='age')),
                ('blue_essence', models.PositiveSmallIntegerField(default=0, verbose_name='blue essence balance')),
                ('rp', models.PositiveSmallIntegerField(default=0, verbose_name='rp balance')),
